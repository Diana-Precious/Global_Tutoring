...
import { Star, MapPin, Clock, CheckCircle, Award, Globe2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Meet our
            <span className="bg-gradient-to-r from-emerald-600 to-teal-700 bg-clip-text text-transparent"> expert tutors</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Learn from the best. Our tutors are carefully selected professionals with proven track records and expertise in their fields.
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-green-600">{tutor.successRate}%</div>
                    </div>
                  </div>
                  ...
                  <div className="flex space-x-2 pt-2">
                    <button className="flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-3 px-4 rounded-xl hover:shadow-lg transition-all duration-300 text-sm font-medium">
                      Book Session
                    </button>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-4 bg-gradient-to-r from-emerald-50 to-teal-50 px-8 py-4 rounded-2xl mb-8">
            <Award className="h-8 w-8 text-emerald-600" />
            <div className="text-left">
              <div className="text-2xl font-bold text-gray-900">2,500+ Expert Tutors</div>
